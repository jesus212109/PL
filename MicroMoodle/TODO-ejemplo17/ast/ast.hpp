...
/*!	
  \class   DivEnteraNode
  \brief   Definition of atributes and methods of DivEnteraNode class
  \note    DivisionNode Class publicly inherits from NumericOperatorNode class 
		   and adds its own printAST and evaluate functions
*/
class DivEnteraNode : public NumericOperatorNode 
{
  public:
/*!		
	\brief Constructor of DivEnteraNode uses NumericOperatorNode's constructor as members initializer
	\param L: pointer to ExpNode
	\param R: pointer to ExpNode
	\post  A new DivEnteraNode is created with the parameter
*/
  DivEnteraNode(ExpNode *L, ExpNode *R): NumericOperatorNode(L,R) 
  {
		// Empty
  }
/*!
	\brief   printAST the DivEnteraNode
	\return  void
	\sa		   evaluateNumber
*/
  void printAST();
...
/*!	
	\brief   Evaluate the DivEnteraNode
	\return  double
	\sa		   printAST
*/
  double evaluateNumber();
...
//DoWhileStmt (hacer-mientras):
class DoWhileStmt : public Statement {
    ExpNode *_cond;
    BlockStmt *_body;
public:
    DoWhileStmt(BlockStmt *body, ExpNode *cond);
    void printAST();
    void evaluate();
};
...
//RepeatStmt (repetir-hasta_que):
class RepeatStmt : public Statement {
    ExpNode *_cond;
    BlockStmt *_body;
public:
    RepeatStmt(BlockStmt *body, ExpNode *cond);
    void printAST();
    void evaluate();
};
...
class SwitchStmt : public Statement {
    ExpNode *_switchExp;
    BlockStmt *_default;
    std::list<CaseClause> _cases;  // o estructura similar
public:
...
//ClearScreenStmt (borrar_pantalla):
